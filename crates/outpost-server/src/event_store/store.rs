...
use outpost_core::events::{EventType, GameEvent};
...
impl EventStore {
    ...
    fn log_event(event_type: &EventType, event_id: u64, turn_number: u64) {
        // Simplified: just log all events with event type debug formatting
        // TODO: Add detailed structured logging per event type
        info!(
            event_id = event_id,
            turn = turn_number,
