...
**Deliberately out of scope for #233** (tracked as sub-issues of #233): tech/bonus-gated building availability and the max-range constraint (#241, delivered — see §8.3C below); promotion of an established outpost into a full colony/city (#242); frontend UI (#243).
