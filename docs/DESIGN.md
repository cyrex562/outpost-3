...
**What's filed as follow-up issues, per this section's own decisions above:** tech-gated remediation that lowers contamination (#388); crating waste into a shippable commodity (#389); networking/compute as a utility feeding population morale (#382); the maintenance condition-stat-plus-breakdown-roll failure model (#384); fixed-link capacity/loss on infrastructure edges (#383).
